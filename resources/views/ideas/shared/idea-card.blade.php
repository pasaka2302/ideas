                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class = "card-title mb-0"><a
                                            href  = "{{ route('users.show', $idea->user->id) }}">{{ $idea->user->name }}</a>
                                        </h5>
                                    </div>
                                </div>
                                <div class  = "d-flex">
                                    <a class = "mx-2 mt-2" href = "{{ route('ideas.show', $idea->id) }}"><i
                                            class = "fas fa-eye" title = "View"></i></a>
                                    @auth
                                        @can('update', $idea)
                                            <a class = "mx-2 mt-2" href = "{{ route('ideas.edit', $idea->id) }}"><i
                                                    class = "fas fa-pen" title = "Edit"></i></a>
