            <div class = "d-flex justify-content-start">
                                ...
                                <a href="#" title="comments" class="fw-light nav-link fs-6 me-3"> <span class="fas fa-comment me-1">
                                    </span> {{ $user->comments()->count() }}
                                </a>
                                <a href = "#" title = "likes" class = "fw-light nav-link fs-6 me-3"> <span class ="fas fa-heart text-danger">
